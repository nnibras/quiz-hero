...
const displayQuiz = (data) => {
  ...
  console.log(document.querySelector("#quizContainer"));
  // const quizContainerInner = document.createElement("div");
  if (!data) {
  ...
  let ques = "";
  data.forEach((quiz, i) => {
    ques += `<div class="m-3 py-3 px-4 shadow-sm rounded">
  ...
  quizContainer.innerHTML = ques;

  // document.getElementById("container").appendChild(quizContainerInner);
};
